...
const AdminNotifications = () => {
  return (
    <div className={styles['notifications-container']}>
      <Card className={styles['notification-card']} title="Notifications">
        {dummyData.map(notification => (
          <Card.Grid key={notification.id} className={styles.notification}>
            <Row gutter={[8, 8]}>
              <Col span={1}>
              ...
              <Col span={21}>
                {notification.people.length > 1 ? (
                  <div className={styles['notification-people']}>
